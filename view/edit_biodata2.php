...
include ('koneksi.php');
$user=$_GET['username'];
$hasil=mysqli_query($koneksi,"select * from pkl where username='$user'");
...
<div class="form-group">
    <input type="hidden" name="id" class="form-control" value="<?php echo $data['id'];?>" readonly class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
  <label>Agama :</label>
  <input type="text" name="agama" class="form-control" value="<?php echo $data['agama'];?>" readonly class="form-control">
</div>
...
<div class="form-group">
  <label>Jurusan :</label>
  <input type="text" name="jurusan" class="form-control" value="<?php echo $data['jurusan'];?>" readonly class="form-control">
</div>
