...
<div class="form-group">
   ...
   <label>Tempat Lahir: </label>
    <input type="text" name="tempat_lahir"onkeypress="return hanyaHuruf(event)" class="form-control" required>
</div>
...
<div class="form-group">
   <label >Telepon: </label>
    <input type="text" name="telepon"onkeypress="return hanyaAngka(event)" class="form-control">
</div>
...
<div class="form-group">
   <label>Mulai PKL : </label>
    <input type="date" name="mulai_pkl" class="form-control">
</div> 
<div class="form-group">
   <label>Selesai PKL : </label>
    <input type="date" name="selesai_pkl" class="form-control">
</div> 
