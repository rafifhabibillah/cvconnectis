...
<body>
                            ...
                            <div class="dropdown-menu dropdown-settings">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <hr/>
                                       <center><h5>Siswa Pkl&Mahasiswa Pkl</h5></center>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a  href="view/index2.php?web=tabel2.php">Data Siswa</a></li>
                            <li><a  href="view/index2.php?web=tabelsilabus.php">Silabus Siswa</a></li>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line"><small>Selamat Datang Siswa</small>  <b>Connectis</b></h4>
